...
export default function MainLayout({ drawerAnimation }) {
  ...
  return (
    <Animated.View
      style={[{ ...drawerAnimation, flex: 1, backgroundColor: COLORS.white }]}
    >
      {/* content */}
      <View style={{ flex: 1 }}>
        <FlatList
          ...
          renderItem={({ item, index }) => {
            return (
              ...
              >
                ...
                {item.screen === SCREENS.Nearby && <AppliedJob />}
                {item.screen === SCREENS.Notifications && <Notifications />}
                {item.screen === SCREENS.Profile && <PhotographerProfile />}
              </View>
            );
          }}
        />
      ...
      >
        ...
        >
          <CustomIcon
            ...
            unSelectedIcon={"briefcase-outline"}
            seletedIcon={"briefcase-outline"}
            isFocused={SELECTEDTAB === SCREENS.AppliedJob ? true : false}
            onPress={() => {
              onTabPressed(SCREENS.AppliedJob);
            }}
          />
          <CustomIcon
            type={FONTFAMILY.Ionicons}
          ...
          <CenterCustomIcon
            ...
            unSelectedIcon={"md-home-outline"}
